...
public class AT07E01Base {
	 ...
	 * message doit etre passe a la fonction decaleLettre() qui se chargera de
	 * l'encoder.
	 * 
	...
	/**
	 * Afiiche les statistiques sur une chaine de caracteres : - le nombre de mots -
	 * la longueur moyenne des mots - la frequence des lettres dans la chaine.
	 * 
	 ...
	 * de fois que chaque lettre alphabetique apparait dans cette chaine. - la case
	 * d'indice 0 correspond a la frequence de 'a', - la case d'indice 1 correspond
	 * a la frequence de 'b', ... - la case d'indice 25 correspond a la frequence de
	 * 'z'
	 * 
